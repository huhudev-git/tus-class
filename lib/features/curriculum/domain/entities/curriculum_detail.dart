...
class CurriculumDetail extends Equatable {
  final String code;
  ...
  factory CurriculumDetail.empty() => CurriculumDetail(
        code: '',
        courseJp: '',
        courseEn: '',
        course: '',
  ...
  factory CurriculumDetail.emptyCache(String code, int year) => CurriculumDetail(
        code: code,
        courseJp: '',
        courseEn: '',
        course: '',
