...
class SyllabusDetailsLoadedPage extends StatefulWidget {
  final SyllabusDetail detail;
  final SyllabusSearchDetailBloc bloc;

  const SyllabusDetailsLoadedPage({Key key, this.detail, this.bloc}) : super(key: key);

  @override
  _SyllabusDetailsLoadedPageState createState() => _SyllabusDetailsLoadedPageState();
}

class _SyllabusDetailsLoadedPageState extends State<SyllabusDetailsLoadedPage> {
  SyllabusDetail get detail => widget.detail;
  SyllabusSearchDetailBloc get bloc => widget.bloc;

  @override
  void dispose() {
    // back
    widget.bloc.state.maybeMap(
      loaded: (state) => widget.bloc.add(
        SyllabusSearchDetailEvent.back(
          year: detail.year,
          code: detail.code,
        ),
      ),
