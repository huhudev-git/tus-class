...
_$_SyllabusDetailModel _$_$_SyllabusDetailModelFromJson(Map json) {
  return _$_SyllabusDetailModel(
...
Map<String, dynamic> _$_$_SyllabusDetailModelToJson(
        _$_SyllabusDetailModel instance) =>
    <String, dynamic>{
      'code': instance.code,
