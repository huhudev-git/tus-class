...
_$_GradeDetailModel _$_$_GradeDetailModelFromJson(Map json) {
  return _$_GradeDetailModel(
...
Map<String, dynamic> _$_$_GradeDetailModelToJson(
        _$_GradeDetailModel instance) =>
    <String, dynamic>{
      'code': instance.code,
