...
import 'resolver/grade_search_filter_resolver.dart';

class GradeSearchPage extends Equatable with GradeSearchFilterResolver implements DirectPage {
  @override
  String toString() => 'GradeSearchPage';
