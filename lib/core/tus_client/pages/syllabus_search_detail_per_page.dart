...
class SyllabusSearchDetailPerPage extends Equatable implements DirectPage {
  final int page;
  final int index;

  const SyllabusSearchDetailPerPage({this.page, this.index});

  @override
  String toString() => 'SyllabusSearchDetailPerPage';
